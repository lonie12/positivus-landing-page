...
const ContactUsSection = () => {
  return (
    <div className="mt-[140px]">
      ...
      />
      <div className="rounded-largeRadius flex justify-between px-[20px] md:px-[50px] md:pl-[100px] py-[40px] bg-[#F3F3F3] overflow-hidden mt-20 relative">
        ...
        <div className="relative right-[-220px]">
          <img className="hidden lg:w-[650px]" src={contactIllustration} />
        </div>
      </div>
    </div>
  );
